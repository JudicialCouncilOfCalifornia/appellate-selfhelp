<?php ?>
            ...
            <form name="f" method="post" action="" id="mo_mmp_feedback">
                ...
                <div class="mo_modal_content">
					...
					<div class="mo-modal-footer">
						<input type="submit" name="miniorange_feedback_submit" class="button button-primary button-large" value="Submit & Deactivate"/>
						<!-- <input type="button" name="miniorange_skip_feedback" class="button button-secondary	 button-large" value="Dissmiss" onclick="document.getElementById('mo_mmp_feedback_form_close').submit();"/> -->
					</div>
				</div>
    ...
    <script>
        ...
        jQuery('a[aria-label="Deactivate Web Application Firewall"]').click(function () {
