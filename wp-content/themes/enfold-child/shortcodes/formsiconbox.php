...
if ( !class_exists( 'avia_sc_forms_icon_box' ) )
{
	class avia_sc_forms_icon_box extends aviaShortcodeTemplate
	{
			/**
			...
			function shortcode_insert_button()
			{
				...
				$this->config['name']			= __('Forms Icon Box', 'avia_framework' );
				$this->config['tab']			= __('Content Elements', 'avia_framework' );
				$this->config['icon']			= AviaBuilder::$path['imagesURL']."sc-icon_box.png";
				$this->config['order']			= 90;
				$this->config['target']			= 'avia-target-insert';
				$this->config['shortcode'] 		= 'av_forms_icon_box';
			...
			function popup_elements()
			{
				$this->elements = array(
					...
					array(
							...
							"desc" 	=> __("Add an Forms IconBox title here",'avia_framework' ),
							"id" 	=> "title",
							"type" 	=> "input",
							"std" 	=> __("FORMS HELP",'avia_framework' )),
                    ...
                    array(
							...
							"id" 	=> "content",
							"type" 	=> "tiny_mce",
							"std" 	=> __("We'll walk you through completing and filling case documents", "avia_framework" )),
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
        		...
        		$output  = '<article class="formsiconbox iconbox iconbox_'.$position.' '.$boxed.' '.$av_display_classes.' '.$meta['el_class'].'" '.$markup.'>';
